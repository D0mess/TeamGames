...
public class MiningScoreboard {

		  public static int mining_red = 0;
		  public static int mining_blue = 0;
		  ...
		  public static void createScoreboard(Player p)
		  {
			...
			Score line11 = score.getScore(Bukkit.getOfflinePlayer("§4Red:§a " + mining_red));
			line11.setScore(11);  
			
			Score line10 = score.getScore(Bukkit.getOfflinePlayer("§9Blue:§a " + mining_blue));
			line10.setScore(10);
			...
			Score line3 = score.getScore(Bukkit.getOfflinePlayer("Mined blocks: §a" + ProfileStats.mining_minedblocks));
			line3.setScore(3);
			
			Score line2 = score.getScore(Bukkit.getOfflinePlayer("§5"));
			line2.setScore(2);
			
			Score line1 = score.getScore(Bukkit.getOfflinePlayer("Gamemode: §aMining"));
			line1.setScore(1);
